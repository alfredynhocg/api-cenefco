...
namespace App\Http\Controllers\MenusAcademicos;
...
class MenuAcademicoController extends Controller
{
    ...
    public function index(Request $request): JsonResponse
    {
        ...
        return response()->json($this->listHandler->handle(new GetMenusAcademicosQuery(
    ...
    {
        $dto = $this->createHandler->handle(new CreateMenuAcademicoCommand(
            idMen:       $request->integer('id_men'),
    ...
    {
        $dto = $this->updateHandler->handle(new UpdateMenuAcademicoCommand(
            idMen:       $id,
            idMod:       $request->integer('id_mod') ?: null,
