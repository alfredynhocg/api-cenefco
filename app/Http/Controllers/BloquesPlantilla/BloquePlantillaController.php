...
namespace App\Http\Controllers\BloquesPlantilla;
...
class BloquePlantillaController extends Controller
{
    ...
    public function index(Request $request): JsonResponse
    {
        ...
        return response()->json($this->listHandler->handle(new GetBloquesPlantillaQuery(
    ...
    {
        $dto = $this->createHandler->handle(new CreateBloquePlantillaCommand(
    ...
    {
        $dto = $this->updateHandler->handle(new UpdateBloquePlantillaCommand(
            idBloqueplantilla: $id,
