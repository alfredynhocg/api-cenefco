...
namespace App\Http\Controllers\SeccionesBloque;
...
class SeccionBloqueController extends Controller
{
    ...
    public function index(Request $request): JsonResponse
    {
        ...
        return response()->json($this->listHandler->handle(new GetSeccionesBloqueQuery(
            pagination:         $pagination,
            idBloqueajustable:  $request->integer('id_bloqueajustable') ?: null,
    ...
    {
        $dto = $this->createHandler->handle(new CreateSeccionBloqueCommand(
            idSeccionbloque:    $request->integer('id_seccionbloque'),
    ...
    {
        $dto = $this->updateHandler->handle(new UpdateSeccionBloqueCommand(
            idSeccionbloque:    $id,
            idBloqueajustable:  $request->integer('id_bloqueajustable') ?: null,
